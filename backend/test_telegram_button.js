...
async function testTelegram() {
  ...
  try {
    ...
    const replyMarkup = {
      inline_keyboard: [
        [
          { text: "✅ Approve", url: `http://localhost:1337/api/payment/admin-action?tx=123456789012&action=approve` },
          { text: "❌ Reject", url: `http://localhost:1337/api/payment/admin-action?tx=123456789012&action=reject` }
        ]
      ]
    };
