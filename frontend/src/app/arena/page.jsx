      ...
      {challenges.map((challenge) => {
        ...
        return (
          <Link href={`/arena/${id}`} key={id}>
            <div className="glass-panel p-6 h-full flex flex-col relative overflow-hidden group hover:-translate-y-1 hover:shadow-[0_0_20px_rgba(245,158,11,0.2)] transition-all cursor-pointer">
              <div className="absolute top-0 right-0 w-32 h-32 bg-amber-500 mix-blend-overlay filter blur-[64px] opacity-10 group-hover:opacity-30 transition-opacity"></div>
              ...
              <h3 className="text-xl font-bold mb-3 group-hover:text-amber-400 transition-colors">{attrs.title}</h3>
              ...
              <div className="mt-6 flex justify-between items-center">
                ...
                <div className="px-4 py-2 bg-white/5 group-hover:bg-amber-500/20 text-white group-hover:text-amber-400 border border-white/10 group-hover:border-amber-500/50 rounded font-mono text-sm transition-colors flex items-center gap-2">
